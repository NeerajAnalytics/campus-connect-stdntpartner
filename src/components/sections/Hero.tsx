...
const Hero: React.FC = () => {
  return <section className="flex flex-col items-center px-4 py-12 font-['Poppins'] max-w-7xl mx-auto">
      ...
      <Link to="/register" className="mt-12 bg-[#1a4e8a] text-white px-12 py-3 rounded-full text-lg font-medium hover:bg-[#153e75] transition-colors">
        Get started
      </Link>
    </section>;
};
